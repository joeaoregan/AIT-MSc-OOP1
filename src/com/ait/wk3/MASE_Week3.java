...
//			e.printStackTrace();
	...
	static public void histogram() {
		try {
			...
			System.out.println("\nUsing while loops:");
			while (i <= rows) {
				// int j=1; // Error: "Duplicate local variable j"
...
//		// Exercise 9 - calling a non-static method from within a 
		// static method
...
//
		...
		MASE_Week3 week3b = new MASE_Week3();
//		// Calling a non-static method from within a static context 
		// using an object...
		sum = week3.addNumbers(2, 3);// addNumbers is non-static
		sum = week3b.addNumbers(2, 3);// addNumbers is non-static
		System.out.println("The sum is " + sum);
//		
		// Calling a static method using an object...
		//int volume = week3.calcVolume(2, 3, 4);
...
//		// Calling a static method using the class name...
	...
	public static void carPark() {
		...
		for (int car = 1; car <= numCars; car++) {
			System.out.print("How many hours was this car parked for? -->");
	...
	public static double calculateCharges(double parkTime) {
		...
		if (parkTime >= MAX_TIME) {
			...
			// If parked there for <= 1 hour then the charge is the minimum
